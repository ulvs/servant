...
################################################################################
## Form generated from reading UI file 'qtMainBDSPVR.ui'
##
...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.dockWidget_2.setMinimumSize(QSize(240, 205))
        ...
        self.qtm_combo.setEditable(True)
        ...
        self.qtm_ip_lin_edit = QLineEdit(self.dockWidgetContents_2)
        self.qtm_ip_lin_edit.setObjectName(u"qtm_ip_lin_edit")

        self.verticalLayout.addWidget(self.qtm_ip_lin_edit)
